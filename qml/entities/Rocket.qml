  ...
  BoxCollider {
    ...
    fixture.onBeginContact: {
      ...
      if(collidingType === "car" ||
          ...
          if(collidingType === "car" && otherEntity.objectName === "car_blue") {
              scene.scoreRed += 1 // increase score
          }
          else if (collidingType === "car" && otherEntity.objectName === "car_red")
          {
             scene.scoreBlue += 1 // increase score
          }
          entity.removeEntity()
